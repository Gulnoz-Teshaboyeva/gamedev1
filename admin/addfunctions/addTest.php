...
if(isset($_GET['submit'])){
    ...
    $res = $connection->query("INSERT INTO test(`name`, `id`, ``, `files`) VALUE('$name', '$id',  '$files')");
...
if(isset($_GET['action']) && ($_GET['action'])){
    if(move_uploaded_file($_FILES['files']['tmp_name'], "D:/OpenServer/domains/localhost/gamedev/upload/test/" .$_FILES['files']['name'])){
...
<p>Название Теста:</p> <input type="text" name="name" id="title">

<!-- <p >Краткое содержание:</p><textarea class="text" rows="20" cols="60" name="description" id="description" maxlength=""></textarea> -->
