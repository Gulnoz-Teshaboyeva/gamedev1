...
if(isset($_GET['submit'])){
    ...
    $res = $connection->query("INSERT INTO lection(`title`, `id`, `description`, `files`,`subject_id`, `status`) VALUE('$title', '$id', '$description', '$files', '$subject_id', '$status' )");
...
if(isset($_GET['action']) && ($_GET['action'])){
    if(move_uploaded_file($_FILES['files']['tmp_name'], "D:/OpenServer/domains/localhost/gamedev/upload/lection/" .$_FILES['files']['name'])){
...
<p>Название Лекции:</p> <input type="text" name="title" id="title">

<p >Краткое содержание:</p><textarea autofocus maxlength="8000" class="text" rows="25" cols="60" name="description" id="description" maxlength=""></textarea>
